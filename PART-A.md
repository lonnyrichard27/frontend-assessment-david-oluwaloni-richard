...
Your work is some of the strongest on the team, which is exactly why it needs to be reviewable. Last week's 900-line PR was approved under deadline pressure. I do not think it was reviewed, which means we shipped it on your reputation rather than a second pair of eyes. That is risk we are carrying.

From now on: PRs under 400 lines, with tests for the logic they add. If something cannot be split, tell me before you start and we will plan it together.

Splitting feels slower. A diff nobody wants to open is slower. Shall we walk through the next one together?
